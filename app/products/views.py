...
#Needs permission, admin lists all products
@api_view(['GET'])
...
#No permission need, list all products
@api_view(['GET'])
...
#No permission need, get product details by ID
@api_view(['GET'])
...
#permission needed, get product details by ID
@api_view(['GET'])
@permission_classes([IsAdminUser])
...
#Permission needed, post a new product 
@api_view(['POST'])
...
#Permission needed, edit products by ID 
@api_view(['PUT'])
@permission_classes([IsAdminUser])
...
#Permission needed, delete product by ID 
@api_view(['DELETE'])
@permission_classes([IsAdminUser])
